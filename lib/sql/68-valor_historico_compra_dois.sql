CREATE OR REPLACE FUNCTION public.valor_historico_compra(dt_registro timestamp without time zone, id_produto bigint, id_empresa bigint, qt_venda numeric) RETURNS numeric
    LANGUAGE plpgsql
    AS $body$
					 declare
