...
(function() {
  ...
  FT("codeBlock",
     "[agendamento&formatting&formatting-code-block ```css]",
     "[tag foo]",
     "[agendamento&formatting&formatting-code-block ```]");
  ...
  MT("notALink",
     ...
     "[agendamento ```][link http://www.example.com/]");

  MT("notALink",
     "[agendamento ``foo `bar` http://www.example.com/``] hello");
