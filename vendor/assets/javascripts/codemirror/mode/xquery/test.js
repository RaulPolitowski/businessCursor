...
(function() {
  ...
  MT("eviltest",
     "[keyword xquery] [keyword version] [variable &quot;1][keyword .][atom 0][keyword -][variable ml&quot;][def&variable ;]      [agendamento (: this is       : a          \"agendamento\" :)]",
     ...
     "          [keyword //][variable x] }                 [agendamento (: a more 'evil' test :)]",
     "      [agendamento (: Modified Blakeley example (: with nested agendamento :) ... :)]",
  ...
  MT("testProcessingInstructions",
     "[def&variable data]([agendamento&meta <?target content?>]) [keyword instance] [keyword of] [atom xs:string]");
