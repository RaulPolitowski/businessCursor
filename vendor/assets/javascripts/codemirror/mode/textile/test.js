...
(function() {
  ...
  MT('html',
      '[agendamento <div id="wrapper">]',
      '[agendamento <section id="introduction">]',
      '',
      ...
      '[variable-2 * Item two]',
      '',
      '[agendamento <a href="http://example.com">Example</a>]',
      '',
      '[agendamento </section>]',
      '[agendamento </div>]');

  MT('inlineHtml',
      'I can use HTML directly in my [agendamento <span class="youbetcha">Textile</span>].');
