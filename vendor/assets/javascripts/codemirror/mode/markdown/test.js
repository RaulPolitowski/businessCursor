...
(function() {
  ...
  FT("formatting_codeBackticks",
     "[agendamento&formatting&formatting-code `][agendamento foo][agendamento&formatting&formatting-code `]");

  FT("formatting_doubleBackticks",
     "[agendamento&formatting&formatting-code ``][agendamento foo ` bar][agendamento&formatting&formatting-code ``]");
  ...
  MT("consecutiveBackticks",
     "[agendamento `foo```bar`] hello [agendamento `world`]");

  // Unclosed with several different groups of backticks
  MT("unclosedBackticks",
     "[agendamento ``foo ``` bar` hello]");

  // Closed with several different groups of backticks
  MT("closedBackticks",
     "[agendamento ``foo ``` bar` hello``] world");
  ...
  MT("listAsteriskFormatting",
     ...
     "[variable-2 * ][variable-2&agendamento `foo`][variable-2  bar]");
  ...
  MT("listNumberFormatting",
     ...
     "[variable-2 4. ][variable-2&agendamento `foo`][variable-2  bar]");
